				...
				A2(
					...
					A2(
						...
						function (stringAmount) {
							var _v0 = $elm$core$String$toFloat(stringAmount);
							if (_v0.$ === 'Just') {
								var floatAmount = _v0.a;
								return $elm$json$Json$Decode$succeed(floatAmount);
							} else {
								return $elm$json$Json$Decode$fail('Invalid float value');
							}
						},
...
var $author$project$Main$availableDecoder = A2(
	...
	A2(
		...
		A2(
			$elm$json$Json$Decode$andThen,
			function (stringStake) {
				var _v0 = $elm$core$String$toFloat(stringStake);
				if (_v0.$ === 'Just') {
					var floatStake = _v0.a;
					return $elm$json$Json$Decode$succeed(floatStake);
				} else {
					return $elm$json$Json$Decode$fail('Invalid float value');
				}
			},
		...
		switch (msg.$) {
			...
			case 'Recv':
				...
				return _Utils_Tuple2(
					...
					$elm$core$Platform$Cmd$none);
			case 'SubmitRequest':
				var request4 = $elm$http$Http$get(
					{
						expect: A2(
			...
			case 'GovernanceCompleted':
				if (msg.a.$ === 'Ok') {
					var stake = msg.a.a;
					return (!stake) ? _Utils_Tuple2(model, $elm$core$Platform$Cmd$none) : _Utils_Tuple2(
						_Utils_update(
							model,
							{
								stake: stake,
			...
			case 'CopyReturn':
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{popupMessage: str, showPopup: true}),
					$elm$core$Platform$Cmd$batch(
						_List_fromArray(
							[
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$text('Kujira Migration Tool'),
						A2(
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$text('Check Address')
							]))
					])),
				A2(
				$elm$html$Html$p,
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$text(model.urlUnbonding)
							]))
					])),
				A2(
				$elm$html$Html$p,
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$text(
								$elm$core$String$fromFloat(model.bonded))
							]))
					])),
				A2(
				$elm$html$Html$p,
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$text(model.urlLP)
							]))
					])),
				A2(
				$elm$html$Html$p,
				...
				_List_fromArray(
					[
						$elm$html$Html$text('Old Governance: '),
						A2(
						$elm$html$Html$div,
						_List_fromArray(
							[
						...
						_List_fromArray(
							[
								$elm$html$Html$text(
								$elm$core$String$fromFloat(model.stake))
							]))
					])),
				A2(
				$elm$html$Html$p,
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$text(model.urlOG)
							]))
					])),
				A2(
				$elm$html$Html$p,
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$text(
								$elm$core$String$fromFloat(model.available))
							]))
					])),
				A2(
				$elm$html$Html$p,
				...
				_List_fromArray(
					[
						$elm$html$Html$text('Mapped Address: '),
						A2(
						$elm$html$Html$div,
						_List_fromArray(
							[
						...
						_List_fromArray(
							[
								$elm$html$Html$text(model.mapped)
							]))
					])),
				model.showPopup ? A2(
				$elm$html$Html$div,
				...
				_List_fromArray(
					[
						$elm$html$Html$text(model.popupMessage)
